...
from garage.tf.misc.tensor_utils import namedtuple_singleton
    ...
    def _build_policy_loss(self, i):
        ...
        with tf.name_scope("policy_loss"):
            with tf.name_scope("advantage"):
                ...
                deltas = rewards + self.discount * baseline_shift \
                         - i.baseline_var
